...
from app.controllers import AuthController, WatchlistController, PortfolioController, AlertController, StorageController, SubscriptionController
...
app.include_router(subscription_controller.get_router())  
